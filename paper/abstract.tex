...
stable regime with arbitrary unfairness. We propose simple fixes and tuning
for ensuring that both protocols converge to and are stable at the fair share point. Finally, using the
...
fundamental limitation of end-to-end delay-based protocols, that we derive.
\end{abstract}
