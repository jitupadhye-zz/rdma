...
\end{thm}
\begin{proof}
Here we provide a brief proof whereas more details can be found in Appendix~\ref{sec:alpha_proof}.
...
from Equation~\ref{eq:converge_rc}. Combining the analysis of $R_T$ in Appendix~\ref{sec:alpha_proof}, we get:
\begin{equation}
\small
\begin{array}{l}
