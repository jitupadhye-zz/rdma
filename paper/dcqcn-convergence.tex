...
``converged'' when the difference of any two flows is less than 10\% of expected
fair share.
...
converge to 20Gbps. Then, at time 0.1, we start the third flow, at 40Gbps. As we
see, the three flows converge to 13Gbps in well within 100ms.
