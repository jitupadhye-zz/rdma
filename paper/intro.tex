...
\fixme{google is no longer using rdma.}
...
\fixme{i think this should be flipped. first we want to answer the broad question. for that we analyze dcqcn and timely.}
...
bursty. \fixme{are we saying that a non-roce datacenter cannot use timely or dcqcn? would packet drops break dcqcn?}
