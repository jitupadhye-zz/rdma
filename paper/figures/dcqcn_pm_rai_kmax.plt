...
plot \
        "pm_rai10_delay0_kmax1000.txt" using ($1):($2) ti "0us delay" w lines ls 3 lc rgb "blue",\
        "pm_rai10_delay50_kmax1000.txt" using ($1):($2) ti "50us delay" w lines ls 2 lc rgb "green",\
