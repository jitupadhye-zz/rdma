...
bottleneck is not affected, just delays. However, the variable delay of feedback directly injects false signal
to the measurements of TIMELY.
...
and TIMELY ($\tau '$) models. Compared with 
