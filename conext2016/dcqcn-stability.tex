...
the number of flows $N$. This is not ideal, since we want the queue length 
controlled independent of the number of flows. With ECN as the signal, we may achieve this
