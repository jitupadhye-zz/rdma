\begin{abstract}
Datacenter networks, and especially drop-free RoCEv2 networks require efficient
...
using fluid models and simulations, for stability, convergence and flow
...
stable at the fair share point. Finally, using the lessons learnt from the
...
switches mark packets, and also due to a fundamental limitation of end-to-end
